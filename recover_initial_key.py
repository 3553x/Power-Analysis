...
rcon = [0x01, 0x02, 0x04, 0x8, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36]
...
def main():
    if(len(sys.argv) != 2):
        print("Please pass the final round key as an arg.")
        sys.exit(-1)

    cur_rk = bytearray.fromhex(sys.argv[1])
    for x in range(9, -1, -1):
        cur_rk = get_old_rk(cur_rk, x)
    
    print("Initial RK found:")
    print(cur_rk.hex())
